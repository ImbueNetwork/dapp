...
async function up(knex) {
    await knex.raw(utils_1.ON_UPDATE_TIMESTAMP_FUNCTION);
    ...
    }).then((0, utils_1.onUpdateTrigger)(knex, usersTableName));
    /**
    ...
    await knex.schema.createTable(web3AccountsTableName, (builder) => {
        ...
        (0, utils_1.auditFields)(knex, builder);
    }).then((0, utils_1.onUpdateTrigger)(knex, web3AccountsTableName));
    ...
    await knex.schema.createTable(federatedCredsTableName, (builder) => {
        ...
        builder.foreign("id")
            ...
            .onUpdate("CASCADE");
        (0, utils_1.auditFields)(knex, builder);
    }).then((0, utils_1.onUpdateTrigger)(knex, federatedCredsTableName));
    ...
    await knex.schema.createTable(projectStatusTableName, builder => {
        ...
        (0, utils_1.auditFields)(knex, builder);
    }).then((0, utils_1.onUpdateTrigger)(knex, projectStatusTableName));
    /**
    ...
    await knex.schema.createTable(projectsTableName, (builder) => {
        ...
        (0, utils_1.auditFields)(knex, builder);
    }).then((0, utils_1.onUpdateTrigger)(knex, projectsTableName));
    /**
    ...
    await knex.schema.createTable(milestonesTableName, (builder) => {
        ...
        (0, utils_1.auditFields)(knex, builder);
    }).then((0, utils_1.onUpdateTrigger)(knex, milestonesTableName));
    /**
...
async function down(knex) {
    ...
    await knex.raw(utils_1.DROP_ON_UPDATE_TIMESTAMP_FUNCTION);
}
exports.down = down;
