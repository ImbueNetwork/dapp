    ...
    <div>
      <div id="funding-info">
        <div className="progress-info">
          <LinearProgress
            progress={(percentageFunded ?? 0) / 100}
            buffer={
              projectOnChain.projectState == ProjectState.OpenForContribution
                ? 0.1
                : 1
            }
          />
          ...
          <div className="funding-goal">
            ...
            <span id="project-detail-currency" className="funds-required">
          ...
          <ProgressBar
            percent={
              ...
              ((lastApprovedMilestoneIndex + 1) /
                projectOnChain.milestones.length)
            }
          >
