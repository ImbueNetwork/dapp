export const stepData = [
  ...
  },
  {
    ...
    content:
      "Consider the size of your project, the team you will require and the time it will take.",
    next: "Time",
    progress: 2.0,
  },
  {
    ...
    content:
      "This is not set in stone, but it will offer those that submit guidance on what you are expecting.",
    next: "Budget",
    progress: 2.5,
  },
  {
