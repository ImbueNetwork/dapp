...
import type MilestoneItem from "../../components/milestoneItem";
import { timeData } from "../../config/briefs-data";
import * as config from "../../config";
import { type Brief, Currency, type Project, type User } from "../../models";
...
export const ApplicationPreview = ({
  ...
  user,
  application,
}: ApplicationPreviewProps): JSX.Element => {
    ...
    <div className="application-container">
      ...
      <div className="section">
        ...
        <div className="container milestones">
          ...
          <div className="budget-info">
            <div className="budget-description">
              <h3>Imbue Service Fee 5% - Learn more about Imbue’s fees</h3>
            </div>
            <div className="budget-value">
...
document.addEventListener("DOMContentLoaded", async (event) => {
  ...
  const briefId = paths.length >= 2 && parseInt(paths[paths.length - 4]);
  const applicationId = paths.length >= 2 && parseInt(paths[paths.length - 2]);
  if (briefId && applicationId) {
    ...
    ReactDOMClient.createRoot(
      ...
      <ApplicationPreview brief={brief} user={user} application={application} />
    );
  }
