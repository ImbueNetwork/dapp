...
import { type Brief, Project, type User } from "../../models";
                ...
                <div className="select-freelancer">
                  ...
                  <div className="ctas-container">
                    ...
                    <button
                      ...
                      onClick={() => {
                        redirectToApplication(application.id);
                      }}
                    >
                      View proposal
                    </button>
                    <button
                      onClick={async () => {
                        await handleMessageBoxClick(application.user_id);
                      }}
