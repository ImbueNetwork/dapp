...
import { type Freelancer, type User } from "../../models";
import {
...
export const Profile = ({ initFreelancer }: ProfileProps): JSX.Element => {
  ...
  const isCurrentFreelancer =
    browsingUser != null && browsingUser.id == freelancer.user_id;
  ...
  const socials = [
    {
      ...
      icon: (
        <FaFacebook
          onClick={() => {
            redirect(freelancer.facebook_link);
          }}
        />
      ),
    },
    {
      ...
      icon: (
        <FaTwitter
          onClick={() => {
            redirect(freelancer.twitter_link);
          }}
        />
      ),
    },
    {
      ...
      icon: (
        <FaTelegram
          onClick={() => {
            redirect(freelancer.telegram_link);
          }}
        />
      ),
    },
    {
      ...
      icon: (
        <FaDiscord
          onClick={() => {
            redirect(freelancer.discord_link);
          }}
        />
      ),
    },
  ...
  const renderChat = (
    ...
    >
      <Modal.Body>
        {browsingUser != null && targetUser != null ? (
      ...
      <div className="info-container">
        <div className="section summary">
          <div className="profile-image">
            <img src="/public/profile-image.png" alt="profile image" />
          </div>
            ...
            <div className="connect-buttons">
              {!isCurrentFreelancer && (
                <>
                  ...
                  {browsingUser != null && showMessageBox && renderChat}
                </>
              )}
...
document.addEventListener("DOMContentLoaded", async (event) => {
  ...
  const username = paths.length >= 2 && paths[paths.length - 2];
