...
module.exports = {
    entry: {
        ...
        "brief-details": path.resolve(
            __dirname,
            "pages",
            "briefs",
            "details.tsx"
        ),
        "brief-applications": path.resolve(
            __dirname,
            "pages",
            "briefs",
            "applications.tsx"
        ),
        "new-freelancer": path.resolve(
            __dirname,
            "pages",
            "freelancer",
            "new.tsx"
        ...
        "freelancer-profile": path.resolve(
            __dirname,
            "pages",
            "freelancer",
            "profile.tsx"
        ...
        "submit-proposal": path.resolve(
            __dirname,
            "pages",
            "briefs",
            "submit.tsx"
        ),
        "application-preview": path.resolve(
            __dirname,
            "pages",
            "briefs",
            "application-preview.tsx"
        ),
        "hirer-dashboard": path.resolve(
            __dirname,
            "pages",
            "briefs",
            "hirer-dashboard.tsx"
